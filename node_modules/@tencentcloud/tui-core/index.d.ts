...
interface ITUICore {
    ...
    */
    getExtensionList(extensionID: string, params?: object): ExtensionInfo[];
    /**
     * 注册广播监听
     * @function
...
export { CallServiceParams, ExtensionInfo, Func, LoginParams, TUIConstants, tuiCore as TUICore, tuiLogin as TUILogin, tuiCore as default };
